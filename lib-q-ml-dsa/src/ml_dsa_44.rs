    ...
    ($modp:ident, $doc:expr) => {
        ...
        pub mod $modp {
            ...
            pub fn generate_key_pair_mut(
                randomness: [u8; KEY_GENERATION_RANDOMNESS_SIZE],
                signing_key: &mut [u8; ml_dsa_44::SIGNING_KEY_SIZE],
                verification_key: &mut [u8; ml_dsa_44::VERIFICATION_KEY_SIZE],
            ) {
                crate::ml_dsa_generic::ml_dsa_44::generate_key_pair::<
                    crate::simd::portable::PortableSIMDUnit,
                    crate::samplex4::portable::PortableSampler,
            ...
            /// may also be empty.
            pub fn sign_mut(
                signing_key: &[u8; ml_dsa_44::SIGNING_KEY_SIZE],
                message: &[u8],
                context: &[u8],
                randomness: [u8; SIGNING_RANDOMNESS_SIZE],
                signature: &mut [u8; ml_dsa_44::SIGNATURE_SIZE],
            ) -> Result<(), SigningError> {
                crate::ml_dsa_generic::ml_dsa_44::sign_mut::<
                    crate::simd::portable::PortableSIMDUnit,
                    crate::samplex4::portable::PortableSampler,
                    crate::hash_functions::portable::Shake128X4,
                    crate::hash_functions::portable::Shake256,
            ...
            pub fn sign_internal(
                ...
                let mut signature = MLDSA44Signature::zero();
                crate::ml_dsa_generic::ml_dsa_44::sign_internal::<
                    crate::simd::portable::PortableSIMDUnit,
                    crate::samplex4::portable::PortableSampler,
                    crate::hash_functions::portable::Shake128X4,
                    crate::hash_functions::portable::Shake256,
            ...
            pub fn verify_internal(
                ...
                crate::ml_dsa_generic::ml_dsa_44::verify_internal::<
                    crate::simd::portable::PortableSIMDUnit,
                    crate::samplex4::portable::PortableSampler,
                    crate::hash_functions::portable::Shake128X4,
                    crate::hash_functions::portable::Shake256,
            ...
            pub fn sign_pre_hashed_shake128(
                ...
                crate::ml_dsa_generic::ml_dsa_44::sign_pre_hashed::<
                    crate::simd::portable::PortableSIMDUnit,
                    crate::samplex4::portable::PortableSampler,
            ...
            pub fn verify_pre_hashed_shake128(
                ...
                let mut pre_hash_buffer = [0u8; 256];
                crate::ml_dsa_generic::ml_dsa_44::verify_pre_hashed::<
                    crate::simd::portable::PortableSIMDUnit,
                    crate::samplex4::portable::PortableSampler,
                    crate::hash_functions::portable::Shake128,
                    crate::hash_functions::portable::Shake128X4,
