pub(crate) use lib_q_ring::constants::{
...
pub(crate) mod ml_dsa_44 {
    ...
    // Type aliases for ML-DSA-44
    pub(crate) const SIGNING_KEY_SIZE: usize = signing_key_size(
        ROWS_IN_A,
        COLUMNS_IN_A,
        error_ring_element_size(BITS_PER_ERROR_COEFFICIENT),
    );
    ...
    pub type MLDSA44KeyPair = crate::MLDSAKeyPair<VERIFICATION_KEY_SIZE, SIGNING_KEY_SIZE>;
    pub type MLDSA44Signature = crate::MLDSASignature<SIGNATURE_SIZE>;
    pub type MLDSA44SigningKey = crate::MLDSASigningKey<SIGNING_KEY_SIZE>;
    pub type MLDSA44VerificationKey = crate::MLDSAVerificationKey<VERIFICATION_KEY_SIZE>;
}
...
pub(crate) mod ml_dsa_65 {
    ...
    pub type MLDSA65KeyPair = crate::MLDSAKeyPair<VERIFICATION_KEY_SIZE, SIGNING_KEY_SIZE>;
    pub type MLDSA65Signature = crate::MLDSASignature<SIGNATURE_SIZE>;
    pub type MLDSA65SigningKey = crate::MLDSASigningKey<SIGNING_KEY_SIZE>;
    pub type MLDSA65VerificationKey = crate::MLDSAVerificationKey<VERIFICATION_KEY_SIZE>;
}
...
pub(crate) mod ml_dsa_87 {
    ...
    pub type MLDSA87KeyPair = crate::MLDSAKeyPair<VERIFICATION_KEY_SIZE, SIGNING_KEY_SIZE>;
    pub type MLDSA87Signature = crate::MLDSASignature<SIGNATURE_SIZE>;
    pub type MLDSA87SigningKey = crate::MLDSASigningKey<SIGNING_KEY_SIZE>;
