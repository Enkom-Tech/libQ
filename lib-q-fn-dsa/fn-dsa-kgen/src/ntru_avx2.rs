...
unsafe fn solve_NTRU_intermediate(
    ...
    unsafe {
        ...
        //   k,t2 can share the same space as rt1,rt2 (shared space)
        {
            ...
            // Share space between k,t2 and rt1,rt2 for memory efficiency
            ...
            if use_sub_ntt {
                ...
                for i in 0..slen_adj {
                    ...
                    for j in 0..n {
                        tn[(i << logn) + j] =
                            zint_mod_small_signed(&ft[j..], slen, n, p, p0i, R2, Rx);
                    }
                ...
                for i in 0..slen_adj {
                    ...
                    for j in 0..n {
                        tn[(i << logn) + j] =
                            zint_mod_small_signed(&gt[j..], slen, n, p, p0i, R2, Rx);
                    }
                    mp_NTT(logn, &mut tn[(i << logn)..], gm, p, p0i);
                }
