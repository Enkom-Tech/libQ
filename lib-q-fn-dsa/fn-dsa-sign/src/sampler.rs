...
impl<T: PRNG> Sampler<T> {
    ...
    fn gaussian0(&mut self) -> i32 {
        ...
        let mut z = 0;
        for gauss_item in &GAUSS0 {
            let cc = v0.wrapping_sub(gauss_item[2]) >> 31;
            let cc = v1.wrapping_sub(gauss_item[1]).wrapping_sub(cc) >> 31;
            let cc = v2.wrapping_sub(gauss_item[0]).wrapping_sub(cc) >> 31;
            z += cc as i32;
        }
        z
    }
...
mod tests {
    ...
    const KAT512_MU_INVSIGMA: [Flr; 2048] = [
        ...
        Flr::scaled(0x1C10A24133ECA0, -52),      // +1.754060988138725463e+00
        Flr::scaled(0x13388C0A5708F4, -52 - 1),  // +6.006527139618627054e-01
        ...
        Flr::scaled(0x1342ED4548370B, -52 - 1),  // +6.019197800794428010e-01
        Flr::scaled(0x17F9435B669C26, -52),      // +1.498355252298787743e+00
        ...
        Flr::scaled(0x1393BFC56B126B, -52 - 1),  // +6.117857795548621302e-01
        Flr::scaled(-0x1AC6571FF2C1A7, -52),     // -1.673422932432097943e+00
        ...
        Flr::scaled(0x15FC7398BB4A6F, -52 - 1),  // +6.870668395079756463e-01
        Flr::scaled(-0x135E7F8CD99540, -52),     // -1.210570860095074863e+00
        ...
        Flr::scaled(0x16A96763AB859A, -52 - 1),  // +7.081791826896506326e-01
        Flr::scaled(0x1FC9EE20FEEB60, -52),      // +1.986799363031160226e+00
        ...
        Flr::scaled(0x1698D6107993F9, -52 - 1),  // +7.061567613387743636e-01
        Flr::scaled(0x13846FD5C9E380, -52),      // +1.219833216773821505e+00
        ...
        Flr::scaled(0x176A6CAA8CB781, -52 - 1),  // +7.317412692116108675e-01
        Flr::scaled(0x17E4640F60D712, -52),      // +1.493259487220204296e+00
        ...
        Flr::scaled(0x178AAFA2AE2978, -52 - 1),  // +7.356794526433949599e-01
        Flr::scaled(-0x17223350E76AB8, -52),     // -1.445849720030919272e+00
        ...
        Flr::scaled(-0x19FCB1DA86FD10, -52),     // -1.624193051931630549e+00
        Flr::scaled(0x175A6BCFA94A4F, -52 - 1),  // +7.297877365002224392e-01
        ...
        Flr::scaled(-0x1FBFBE3EE7A0D6, -52),     // -1.984312291833750574e+00
        Flr::scaled(0x176DAAAB728FAF, -52 - 1),  // +7.321370457252579511e-01
        ...
        Flr::scaled(0x1CC09A0F612D60, -52),      // +1.797021923138196087e+00
        Flr::scaled(0x182D490AD7E9F8, -52 - 1),  // +7.555279933724809993e-01
        ...
        Flr::scaled(0x18567574514F4D, -52 - 1),  // +7.605540534809535069e-01
        Flr::scaled(0x11A6FAD2CEE039, -52),      // +1.103266547650504359e+00
        ...
        Flr::scaled(0x1CDC92545544C0, -52),      // +1.803850488115401163e+00
        Flr::scaled(0x175A5C4BEAA834, -52 - 1),  // +7.297803385492955819e-01
        ...
        Flr::scaled(0x176402E14C7E1A, -52 - 1),  // +7.309584045760317839e-01
        Flr::scaled(0x1CB48BF5B939A0, -52),      // +1.794078788621483511e+00
