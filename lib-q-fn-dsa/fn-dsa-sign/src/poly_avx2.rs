            ...
            for i in 0..hm {
                if ht >= 4 {
                    ...
                    for j in 0..(ht >> 2) {
                        ...
                        let z_re =
                            _mm256_sub_pd(_mm256_mul_pd(s_re, y_re), _mm256_mul_pd(s_im, y_im));
                        let z_im =
                            _mm256_add_pd(_mm256_mul_pd(s_re, y_im), _mm256_mul_pd(s_im, y_re));
            ...
            for i in 0..(hm >> 1) {
                if t >= 4 {
                    ...
                    for j in 0..(t >> 2) {
                        ...
                        let z_re =
                            _mm256_sub_pd(_mm256_mul_pd(x_re, s_re), _mm256_mul_pd(x_im, s_im));
                        let z_im =
                            _mm256_add_pd(_mm256_mul_pd(x_re, s_im), _mm256_mul_pd(x_im, s_re));
    ...
    unsafe {
        ...
        if logn >= 3 {
            ...
            for i in 0..(1usize << (logn - 3)) {
                ...
                let zo_re =
                    _mm256_add_pd(_mm256_mul_pd(mu_re, g01_re), _mm256_mul_pd(mu_im, g01_im));
