...
// Original Falcon support has been removed for security reasons.
// The original Falcon design bypassed domain separation, creating a
// critical security vulnerability that could enable cross-protocol attacks.
// All operations now use proper FN-DSA domain separation as specified
...
pub fn hash_to_point(
    ...
    // Original Falcon support has been removed for security reasons.
    // The implementation now properly enforces domain separation as required
    // by the FN-DSA specification, preventing cross-protocol attacks.
    ...
    // Always use proper FN-DSA domain separation for security
