...
use crate::benes::support_gen;
use crate::bm::bm;
use crate::gf::gf_iszero;
...
mod tests {
    ...
    #[test]
    fn test_decrypt() {
        let sk = TestData::new().u8vec("cbkem8192128f_sk1"); // TODO: sk has wrong size … IRR_BYTES + COND_BYTES required
        let mut c = TestData::new().u8vec("cbkem8192128f_ct1");
        let expected_error_vector = TestData::new().u8vec("cbkem8192128f_decrypt_errvec");
