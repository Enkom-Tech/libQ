...
use crate::root::root;
use crate::uint64_sort::uint64_sort;
use crate::util::{
    bitrev,
    load_gf,
};
...
/// 4096 for cbkem348864 and 8192 for cbkem8192128.
...
mod tests {
    ...
    fn test_mov_columns() {
        ...
        let mat_data = TestData::new().u8vec("cbkem8192128f_mat_before");
        ...
        let mut pi = TestData::new().i16vec("cbkem8192128f_pi_before");
        let mut pivots = 0u64;
        ...
        let mat_expected_data = TestData::new().u8vec("cbkem8192128f_mat_expected");

        for row in 0..PK_NROWS {
            mat_expected[row].copy_from_slice(&mat_expected_data[row * COLS..(row + 1) * COLS]);
        }

        let pi_expected = TestData::new().i16vec("cbkem8192128f_pi_expected");
    ...
    fn test_pk_gen_1() {
        ...
        let pk_expected = TestData::new().u8vec("cbkem8192128f_pk_gen_pk_expected");
        let sk_expected = TestData::new().u8vec("cbkem8192128f_pk_gen_sk_expected");
        let perm_expected = TestData::new().u32vec("cbkem8192128f_pk_gen_perm_expected");
        let pi_expected = TestData::new().i16vec("cbkem8192128f_pk_gen_pi_expected");
    ...
    fn test_pk_gen_2() {
        ...
        let sk_data = TestData::new().u8vec("cbkem8192128f_pk_gen_sk2_input");
        let perm_data = TestData::new().u32vec("cbkem8192128f_pk_gen_perm2_input");
        let pi_data = TestData::new().i16vec("cbkem8192128f_pk_gen_pi2_input");
        ...
        let pk_expected = TestData::new().u8vec("cbkem8192128f_pk_gen_pk2_expected");
        let sk_expected = TestData::new().u8vec("cbkem8192128f_pk_gen_sk2_expected");
        let perm_expected = TestData::new().u32vec("cbkem8192128f_pk_gen_perm2_expected");
        let pi_expected = TestData::new().i16vec("cbkem8192128f_pk_gen_pi2_expected");
