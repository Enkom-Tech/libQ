...
mod tests {
    ...
    fn test_controlbitsfrompermutation_kat3_cbkem348864() {
        ...
        let out_ref = TestData::new().u8vec("controlbits_kat3_cbkem348864_out_ref");
    ...
    fn test_controlbitsfrompermutation_kat8_cbkem348864() {
        ...
        let out_ref = TestData::new().u8vec("controlbits_kat8_cbkem348864_out_ref");
        assert_eq!(out, out_ref.as_slice());
    }
    ...
    fn test_controlbitsfrompermutation_kat9_cbkem348864() {
        ...
        let out_ref = TestData::new().u8vec("controlbits_kat9_cbkem348864_out_ref");
        assert_eq!(out, out_ref.as_slice());
    }
    ...
    fn test_controlbitsfrompermutation_kat3_cbkem6960119() {
        ...
        let pi = TestData::new().i16vec("controlbits_kat3_cbkem6960119_pi");
        controlbitsfrompermutation(&mut out, &pi, 13, 8192);

        let out_ref = TestData::new().u8vec("controlbits_kat3_cbkem6960119_out_ref");
        assert_eq!(out, out_ref.as_slice());
    }
}
