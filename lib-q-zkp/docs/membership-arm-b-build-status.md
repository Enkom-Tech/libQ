...
| 1 | …degree-4 binomial extension for FRI challenges + DFT exposure | TODO (next iteration) |
| 2 | BabyBear Poseidon2 value-level permutation + KAT vs reference | NOT STARTED (blocked on constant sourcing — see Finding F1) |
