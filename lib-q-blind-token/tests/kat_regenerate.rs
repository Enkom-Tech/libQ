//! Regenerates `tests/vectors/blind-token-v1.json` + `manifest.json` (run with `--ignored`).
...
#[test]
#[ignore = "regenerates tests/vectors/blind-token-v1.json"]
