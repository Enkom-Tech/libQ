...
mod tests {
    ...
    fn test_horizontally_packed_row() {
        ...
        // Create an inner matrix of Mersenne31 elements.
        // Matrix layout:
        // [ 1  2 ]
        // [ 3  4 ]
        ...
        assert_eq!(
            packed,
            &[Packed::from([Mersenne31::new(3), Mersenne31::new(4)])]
        );
    ...
    fn test_padded_horizontally_packed_row() {
        ...
        type Packed = FieldArray<Mersenne31, 3>;

        // Create a 2x2 matrix of Mersenne31 elements:
        // [ 1  2 ]
        // [ 3  4 ]
        let inner = RowMajorMatrix::new(
            vec![
