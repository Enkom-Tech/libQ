...
/// Zeroize implementation for RowMajorMatrix containing field elements.
///
/// This ensures that secret witness data stored in matrices is cleared from memory
/// when the matrix is dropped, preventing memory-based side-channel attacks.
///
/// # Security
///
/// When a `RowMajorMatrix` containing secret field elements (such as witness traces)
/// is dropped, all values are zeroized to prevent memory-based side-channel attacks.
/// This is especially important for STARK proof generation where witness data must
/// remain secret.
impl<T> Zeroize for RowMajorMatrix<T>
where
    T: Field + Zeroize,
{
    fn zeroize(&mut self) {
        // Zeroize all field elements in the matrix
...
mod tests {
    ...
    fn test_scale_row() {
        ...
        matrix.scale_row(1, Mersenne31::new(3));
        assert_eq!(
            matrix.values,
            vec![
                Mersenne31::new(1),
    ...
    fn test_horizontally_packed_row() {
        type Packed = FieldArray<Mersenne31, 2>;
        ...
        assert_eq!(
            packed,
            vec![Packed::from([Mersenne31::new(4), Mersenne31::new(5)])]
        );
        assert_eq!(suffix, vec![Mersenne31::new(6)]);
    }
    ...
    fn test_padded_horizontally_packed_row() {
        ...
        assert_eq!(
            packed,
            vec![
                Packed::from([Mersenne31::new(4), Mersenne31::new(5)]),
                Packed::from([Mersenne31::new(6), Mersenne31::new(0)])
            ]
        );
    }
    ...
    fn test_flatten_to_base() {
        ...
        let flattened: RowMajorMatrix<Mersenne31> = matrix.flatten_to_base();
    ...
    fn test_horizontally_packed_row_mut() {
        ...
        packed[0] = Packed::from([Mersenne31::new(9), Mersenne31::new(10)]);
        suffix[0] = Mersenne31::new(11);
    ...
    fn test_packed_row_pair_mut() {
        ...
        packed1[0] = Packed::from([Mersenne31::new(7), Mersenne31::new(8)]);
        packed2[0] = Packed::from([Mersenne31::new(33), Mersenne31::new(44)]);
        sfx1[0] = Mersenne31::new(99);
        sfx2[0] = Mersenne31::new(9);
    ...
    fn test_vertically_packed_row_pair() {
        ...
        let matrix = RowMajorMatrix::new((1..17).map(Mersenne31::new).collect::<Vec<_>>(), 4);
        ...
        assert_eq!(
            ...
            (1..5)
                .chain(9..13)
                .map(|i| [Mersenne31::new(i), Mersenne31::new(i + 4)].into())
                .collect::<Vec<_>>(),
        );
    }
    ...
    fn test_vertically_packed_row_pair_wraparound_start_1() {
        ...
        assert_eq!(
            packed,
            vec![
                Packed::from([Mersenne31::new(5), Mersenne31::new(9)]),
                Packed::from([Mersenne31::new(6), Mersenne31::new(10)]),
                Packed::from([Mersenne31::new(7), Mersenne31::new(11)]),
                Packed::from([Mersenne31::new(8), Mersenne31::new(12)]),
                Packed::from([Mersenne31::new(13), Mersenne31::new(1)]),
                Packed::from([Mersenne31::new(14), Mersenne31::new(2)]),
                Packed::from([Mersenne31::new(15), Mersenne31::new(3)]),
                Packed::from([Mersenne31::new(16), Mersenne31::new(4)]),
            ]
        );
    }
}
