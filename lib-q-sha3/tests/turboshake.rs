...
fn turboshake128_6_basic_functionality() {
    let hasher = lib_q_sha3::TurboShake128::<6>::default();
    ...
    let hasher2 = lib_q_sha3::TurboShake128::<6>::default();
...
fn turboshake128_7_basic_functionality() {
    let hasher = lib_q_sha3::TurboShake128::<7>::default();

    let mut output1 = [0u8; 32];
    let mut output2 = [0u8; 32];

    let hasher2 = lib_q_sha3::TurboShake128::<7>::default();
...
fn turboshake256_6_basic_functionality() {
    let hasher = lib_q_sha3::TurboShake256::<6>::default();

    let mut output1 = [0u8; 64];
    let mut output2 = [0u8; 64];

    let hasher2 = lib_q_sha3::TurboShake256::<6>::default();
...
fn turboshake256_7_basic_functionality() {
    let hasher = lib_q_sha3::TurboShake256::<7>::default();

    let mut output1 = [0u8; 64];
    let mut output2 = [0u8; 64];

    let hasher2 = lib_q_sha3::TurboShake256::<7>::default();
...
fn turboshake_domain_separator_difference() {
    ...
    let hasher6 = lib_q_sha3::TurboShake128::<6>::default();
    let hasher7 = lib_q_sha3::TurboShake128::<7>::default();
...
fn turboshake_consistency() {
    ...
    let hasher1 = lib_q_sha3::TurboShake128::<6>::default();
    let hasher2 = lib_q_sha3::TurboShake128::<6>::default();
    let mut output1 = [0u8; 32];
    let mut output2 = [0u8; 32];
