...
new_cshake_test!(cshake128, lib_q_sha3::CShake128);
new_cshake_test!(cshake256, lib_q_sha3::CShake256);

// When bytepad output aligns exactly to the block boundary (SP 800-185 2.3.3), regression #834.
new_cshake_test!(cshake128_bytepad_block_aligned, lib_q_sha3::CShake128);
new_cshake_test!(cshake256_bytepad_block_aligned, lib_q_sha3::CShake256);
