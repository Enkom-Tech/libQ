...
// Note: Mersenne31 does NOT support direct degree 4 binomial extensions
// because 4 does not divide (p-1) where p = 2^31 - 1.
// For degree 4 extensions, use Complex<Mersenne31> with degree 2:
//   BinomialExtensionField<Complex<Mersenne31>, 2>
// This gives a total degree of 4 over the base field.
...
mod test_cubic_complex_extension {
    ...
    // Note: lib_q_stark_field_testing crate not available in lib-Q
    // Field property tests are implemented manually or disabled
    use num_bigint::BigUint;
