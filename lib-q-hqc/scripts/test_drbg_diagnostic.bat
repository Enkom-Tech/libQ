@echo off
REM DRBG Diagnostic Mode Test Suite for Windows
REM This script runs the diagnostic mode tests to analyze DRBG interoperability
...
REM Run the dedicated DRBG interoperability tests
