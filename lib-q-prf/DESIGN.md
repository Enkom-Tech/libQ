...
- A constrained-PRF-for-OT construction in this adjacent space — the isogeny-group-action CPRF and silent-OT PCF of IACR ePrint 2026/1444 — is tracked but **out of scope / not adopted**; see [`docs/radar/eprint-2026-1444-isogeny-silent-ot.md`](../docs/radar/eprint-2026-1444-isogeny-silent-ot.md). It sits past this boundary (isogeny group action rather than \(\mathbb{F}_p\), and a constrained/membership predicate rather than a bare PRF).
