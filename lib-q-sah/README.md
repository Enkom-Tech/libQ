...
capable libQ nodes. Canonical, deployable implementation of the primitive defined
in `libQ-SPEC/spec/crypto/sah/sah.md`.
...
The libQ SDK does **not** depend on this crate directly. S-A-H is exposed through
