...
mod tests {
    ...
    #[derive(Debug)]
    struct MockAir {
        constraints: Vec<SymbolicVariable<Mersenne31>>,
        width: usize,
    }

    impl BaseAir<Mersenne31> for MockAir {
        fn width(&self) -> usize {
            self.width
        }
    }

    impl Air<SymbolicAirBuilder<Mersenne31>> for MockAir {
        fn eval(&self, builder: &mut SymbolicAirBuilder<Mersenne31>) {
    ...
    fn test_symbolic_air_builder_initialization() {
        let builder = SymbolicAirBuilder::<Mersenne31>::new(2, 4, 3, 0, 0);

        let expected_main = [
            SymbolicVariable::<Mersenne31>::new(Entry::Main { offset: 0 }, 0),
            SymbolicVariable::<Mersenne31>::new(Entry::Main { offset: 0 }, 1),
            SymbolicVariable::<Mersenne31>::new(Entry::Main { offset: 0 }, 2),
            SymbolicVariable::<Mersenne31>::new(Entry::Main { offset: 0 }, 3),
            SymbolicVariable::<Mersenne31>::new(Entry::Main { offset: 1 }, 0),
            SymbolicVariable::<Mersenne31>::new(Entry::Main { offset: 1 }, 1),
            SymbolicVariable::<Mersenne31>::new(Entry::Main { offset: 1 }, 2),
    ...
    fn test_symbolic_air_builder_assert_zero() {
        let mut builder = SymbolicAirBuilder::<Mersenne31>::new(2, 4, 3, 0, 0);
        let expr = SymbolicExpression::Constant(Mersenne31::new(5));
        ...
        assert!(
            constraints.iter().any(
                |x| matches!(x, SymbolicExpression::Constant(val) if *val == Mersenne31::new(5))
            ),
