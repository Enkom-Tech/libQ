    ...
    BinomialExtensionField<F, D>: ExtensionField<F>,
{
    ...
    /// This works for Mersenne31, KoalaBear, Mersenne31, and any future field
...
mod tests {
    ...
    fn test_symbolic_expression_degree_multiple() {
        let constant_expr = SymbolicExpression::<Mersenne31>::Constant(Mersenne31::new(5));
        assert_eq!(
        ...
        let permutation_var = SymbolicExpression::Variable(SymbolicVariable::<Mersenne31>::new(
        ...
        let public_var =
            SymbolicExpression::Variable(SymbolicVariable::<Mersenne31>::new(Entry::Public, 4));
        assert_eq!(
        ...
        let challenge_var =
            SymbolicExpression::Variable(SymbolicVariable::<Mersenne31>::new(Entry::Challenge, 5));
        assert_eq!(
        ...
        let is_first_row = SymbolicExpression::<Mersenne31>::IsFirstRow;
        assert_eq!(
        ...
        let is_last_row = SymbolicExpression::<Mersenne31>::IsLastRow;
        assert_eq!(
        ...
        let is_transition = SymbolicExpression::<Mersenne31>::IsTransition;
        assert_eq!(
        ...
        let add_expr = SymbolicExpression::<Mersenne31>::Add {
        ...
        let sub_expr = SymbolicExpression::<Mersenne31>::Sub {
            x: Arc::new(variable_expr.clone()),
            y: Arc::new(preprocessed_var.clone()),
            degree_multiple: 1,
        };
        ...
        let neg_expr = SymbolicExpression::<Mersenne31>::Neg {
            x: Arc::new(variable_expr.clone()),
            degree_multiple: 1,
        };
        assert_eq!(
        ...
        let mul_expr = SymbolicExpression::<Mersenne31>::Mul {
    ...
    fn test_addition_of_constants() {
        let a = SymbolicExpression::Constant(Mersenne31::new(3));
        let b = SymbolicExpression::Constant(Mersenne31::new(4));
        let result = a + b;
        match result {
            SymbolicExpression::Constant(val) => assert_eq!(val, Mersenne31::new(7)),
    ...
    fn test_subtraction_of_constants() {
        let a = SymbolicExpression::Constant(Mersenne31::new(10));
        let b = SymbolicExpression::Constant(Mersenne31::new(4));
        let result = a - b;
        match result {
            SymbolicExpression::Constant(val) => assert_eq!(val, Mersenne31::new(6)),
    ...
    #[test]
    fn test_negation() {
        let a = SymbolicExpression::Constant(Mersenne31::new(7));
        let result = -a;
        match result {
            SymbolicExpression::Constant(val) => {
                assert_eq!(val, Mersenne31::NEG_ONE * Mersenne31::new(7));
            }
    ...
    fn test_multiplication_of_constants() {
        let a = SymbolicExpression::Constant(Mersenne31::new(3));
        let b = SymbolicExpression::Constant(Mersenne31::new(5));
        let result = a * b;
        match result {
            SymbolicExpression::Constant(val) => assert_eq!(val, Mersenne31::new(15)),
    ...
    fn test_degree_multiple_for_addition() {
        let a = SymbolicExpression::Variable::<Mersenne31>(SymbolicVariable::new(
            Entry::Main { offset: 0 },
            1,
        ));
        let b = SymbolicExpression::Variable::<Mersenne31>(SymbolicVariable::new(
            Entry::Main { offset: 0 },
            2,
        ));
        let result = a + b;
    ...
    fn test_sum_operator() {
        let expressions = vec![
            SymbolicExpression::Constant(Mersenne31::new(2)),
            SymbolicExpression::Constant(Mersenne31::new(3)),
            SymbolicExpression::Constant(Mersenne31::new(5)),
        ];
        let result: SymbolicExpression<Mersenne31> = expressions.into_iter().sum();
        match result {
            SymbolicExpression::Constant(val) => assert_eq!(val, Mersenne31::new(10)),
    ...
    fn test_product_operator() {
        let expressions = vec![
            SymbolicExpression::Constant(Mersenne31::new(2)),
            SymbolicExpression::Constant(Mersenne31::new(3)),
            SymbolicExpression::Constant(Mersenne31::new(4)),
        ];
        let result: SymbolicExpression<Mersenne31> = expressions.into_iter().product();
        match result {
            SymbolicExpression::Constant(val) => assert_eq!(val, Mersenne31::new(24)),
    ...
    fn test_default_is_zero() {
        ...
        let expr: SymbolicExpression<Mersenne31> = Default::default();

        // Verify it matches the zero constant.
        assert!(matches!(
            expr,
            SymbolicExpression::Constant(c) if c == Mersenne31::ZERO
        ));
    }
    ...
    fn test_ring_constants() {
        ...
        assert!(matches!(
            SymbolicExpression::<Mersenne31>::ZERO,
            SymbolicExpression::Constant(c) if c == Mersenne31::ZERO
        ));

        // ONE is a Constant variant wrapping the field's one element.
        assert!(matches!(
            SymbolicExpression::<Mersenne31>::ONE,
            SymbolicExpression::Constant(c) if c == Mersenne31::ONE
        ));

        // TWO is a Constant variant wrapping the field's two element.
        assert!(matches!(
            SymbolicExpression::<Mersenne31>::TWO,
            SymbolicExpression::Constant(c) if c == Mersenne31::TWO
        ));

        // NEG_ONE is a Constant variant wrapping the field's -1 element.
        assert!(matches!(
            SymbolicExpression::<Mersenne31>::NEG_ONE,
            SymbolicExpression::Constant(c) if c == Mersenne31::NEG_ONE
        ));
    }
    ...
    fn test_from_symbolic_variable() {
        ...
        let var = SymbolicVariable::<Mersenne31>::new(Entry::Main { offset: 0 }, 3);

        // Convert to expression.
        let expr: SymbolicExpression<Mersenne31> = var.into();
    ...
    fn test_from_field_element() {
        ...
        let field_val = Mersenne31::new(42);
        let expr: SymbolicExpression<Mersenne31> = field_val.into();
    ...
    fn test_from_prime_subfield() {
        ...
        let prime_subfield_val = <Mersenne31 as PrimeCharacteristicRing>::PrimeSubfield::new(7);
        let expr = SymbolicExpression::<Mersenne31>::from_prime_subfield(prime_subfield_val);

        // Verify it produces a constant with the converted value.
        assert!(matches!(
            expr,
            SymbolicExpression::Constant(c) if c == Mersenne31::new(7)
        ));
    }
    ...
    fn test_assign_operators() {
        ...
        let mut expr = SymbolicExpression::Constant(Mersenne31::new(5));
        expr += SymbolicExpression::Constant(Mersenne31::new(3));
        assert!(matches!(
            expr,
            SymbolicExpression::Constant(c) if c == Mersenne31::new(8)
        ));

        // Test SubAssign with constants (should simplify).
        let mut expr = SymbolicExpression::Constant(Mersenne31::new(10));
        expr -= SymbolicExpression::Constant(Mersenne31::new(4));
        assert!(matches!(
            expr,
            SymbolicExpression::Constant(c) if c == Mersenne31::new(6)
        ));

        // Test MulAssign with constants (should simplify).
        let mut expr = SymbolicExpression::Constant(Mersenne31::new(6));
        expr *= SymbolicExpression::Constant(Mersenne31::new(7));
        assert!(matches!(
            expr,
            SymbolicExpression::Constant(c) if c == Mersenne31::new(42)
        ));
    }
    ...
    fn test_negation_creates_neg_node() {
        ...
        let var = SymbolicExpression::Variable::<Mersenne31>(SymbolicVariable::new(
            Entry::Main { offset: 0 },
            0,
        ));
    ...
    fn test_empty_sum_returns_zero() {
        ...
        let empty: Vec<SymbolicExpression<Mersenne31>> = vec![];
        let result: SymbolicExpression<Mersenne31> = empty.into_iter().sum();
    ...
    fn test_empty_product_returns_one() {
        ...
        let empty: Vec<SymbolicExpression<Mersenne31>> = vec![];
        let result: SymbolicExpression<Mersenne31> = empty.into_iter().product();
    ...
    fn test_mixed_degree_addition() {
        ...
        let constant = SymbolicExpression::Constant(Mersenne31::new(5));
        ...
        match result {
            SymbolicExpression::Add {
                ...
                assert!(matches!(
                    x.as_ref(),
                    SymbolicExpression::Constant(c) if *c == Mersenne31::new(5)
                ));
    ...
    fn test_chained_multiplication_degree() {
        ...
        let c = SymbolicExpression::Variable::<Mersenne31>(SymbolicVariable::new(
            Entry::Main { offset: 0 },
            2,
        ));
